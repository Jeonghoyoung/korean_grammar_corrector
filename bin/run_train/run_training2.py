...
from keras_model.keras_tensorflow_cust_v2 import *
...
class Trainer:
    def __init__(self, save_path=None, tokenizer_name=None, model_name=None, d_model=32, num_heads=4, dff=64, max_length=10,
    ...
    def __load_data(self, data, d_type):
        ...
        if d_type == 'path':
            ...
            if extension == '.csv':
                df = pd.read_csv(data, error_bad_lines=False,names=['src', 'tgt'])
                return df[['src', 'tgt']]
            elif extension == '.xlsx':
